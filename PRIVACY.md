...
Gewu does not sell user data.

Gewu does not use user data for advertising, creditworthiness, or unrelated purposes.

Gewu sends page content and user questions only to the AI provider configured by the user, and only when needed to provide translation or question answering.
...
For privacy questions, contact the publisher using the contact email listed on the Chrome Web Store item page.
